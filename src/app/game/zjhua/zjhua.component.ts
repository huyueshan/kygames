...
@Component({
  selector: 'app-zjhua',
  templateUrl: './zjhua.component.html',
  styleUrls: ['./zjhua.component.scss']
})
export class ZjhuaComponent implements OnInit {
  constructor(
    private el: ElementRef,
    public Base: BaseService,
    public Store: ZjhuaService,
  ...
  public init() {
    ...
    bg_1.src = "../../../assets/images/zjhua/zjh_bg.jpg";
    ...
    this.timer = setInterval(function() {
      ...
      switch (ST.STATE) {
        case 0:
          ...
          Utils.FN.DrawObj(ctx, ST, ["I_icon_man"]);
